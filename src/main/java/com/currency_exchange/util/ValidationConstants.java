...
public final class ValidationConstants {
    ...
    public static final String NAME_PATTERN = "^[\\p{L}\\s\\-]{2,15}$";
    public static final String CODE_PATTERN = "^[A-Za-z]{3}$";
    public static final String SIGN_PATTERN = "^\\p{Sc}";
    ...
    public static final String NAME_ERROR_MESSAGE = "Currency name must be 2-15 latin letters";
    public static final String CODE_ERROR_MESSAGE = "Currency code must be 3 latin letters";
    public static final String SIGN_ERROR_MESSAGE = "Currency sign must be a valid symbol (e.g. $, €...";
