...
public final class ValidationUtils {
    ...
    static void validateRequest(Map<String, String[]> params, String... requiredParams) {
    ...
    static void validateRate(String rate) {
    ...
    static void validateCurrencyName(String name) {
        RequestValidator.validateStringPattern(name, NAME_PATTERN, NAME_ERROR_MESSAGE);
    }

    static void validateCurrencySign(String sign) {
        RequestValidator.validateStringPattern(sign, SIGN_PATTERN, SIGN_ERROR_MESSAGE);
    }

    static void checkCurrenciesAreDifferent(String baseCode, String targetCode) {
