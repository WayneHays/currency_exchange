...
- ✅ Автоматическое создание и инициализация базы данных
...
2. **Настройка конфигурации:**
   ...
   db.pool.size=5
   ```
   Для корректного отображения фронтенда в браузере необходимо прописать в файле /webapps/js/app.js:
   const host = "http://localhost:8080"

   При развертывании на сервере необходимо заменить эту строчку на строку вида http://62.109.22.177:8080/currency_exchange-1.0 с адресом приложения на сервере.
